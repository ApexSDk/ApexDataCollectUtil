...
//单个上传
- (void)uploadDataToServer:(id)datas url:(NSString *)url responseSuccess:(callBackSuccess)success responseFailed:(callBackFailed)failed;
- (void)uploadDataToServer:(id)datas url:(NSString *)url accessToken:(NSString *)token responseSuccess:(callBackSuccess)success responseFailed:(callBackFailed)failed;
-(void)getConfigInfoWithUrl:(NSString *)url responseSuccess:(callBackSuccess)success responseFailed:(callBackFailed)failed;
