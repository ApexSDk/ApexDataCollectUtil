...
- (NSURLRequest *)postRequestURL:(NSString *)url params:(id)params accessToken:(NSString *)token responseSuccess:(callBackSuccess)success fail:(callBackFailed)failed;
